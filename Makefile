...
exp:
	g++ -O3 -DCUTTHRU -DNDEBUG -DFEAT_DOF -DUSE_TBB -DFEAT_GLOSSY -DFEAT_REFRACT src/*.cc -Iinclude -I/usr/local/Cellar/tbb/4.4-20151115/include -L/usr/local/Cellar/tbb/4.4-20151115/lib -ltbb `pkg-config --cflags OpenEXR` `pkg-config --libs OpenEXR` -o raytra --std=c++11
